...
parser.add_argument('--flow', type=str2bool, default=False, help='model use flow or not, for test')
parser.add_argument('--autodata', type=str2bool, default=True, help='model use autodata or not, for test')
